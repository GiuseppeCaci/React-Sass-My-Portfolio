    ...
    <>
      ...
      <div className="container-title">
        ...
        <div className="container-about-softSkill">
            <h2>Soft Skill</h2>
            <ul>
                <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Iste aliquid iure quia tenetur veniam pariatur deleniti id excepturi facilis modi est animi sequi quos beatae, corporis alias consequuntur quo eveniet atque sunt saepe numquam aperiam corrupti soluta? Rem, sequi aperiam?</li>
                <li>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Animi, incidunt.</li>
                <li>Lorem ipsum, dolor sit amet consectetur adipisicing elit. Laudantium pariatur accusamus alias ad nesciunt. Voluptatum quos facilis repellendus ducimus ipsa.</li>
                <li>Lorem ipsum dolor sit amet consectetur adipisicing elit. Vel, natus.</li>
                <li>Lorem ipsum dolor sit, amet consectetur adipisicing elit. Temporibus laboriosam quidem tenetur nisi possimus! Commodi, beatae quisquam maxime nesciunt consequatur voluptate laborum impedit rem nemo!</li>
            </ul>
        </div>
      </div>
    </>
