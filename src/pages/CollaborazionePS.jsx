...
const CollaborazionePS = () => {
  ...
  return (
    <>
      <div className={`container-collaborazione-title ${theme} primary`}>
      ...
      <div className={`base-container-normal ${theme} primary`}>
        <div className="main-container-secondary--large">
          ...
          <p>
            ...
            studiato cinema, ho studiato design e programmazione.ho frequentato
            diversi corsi di front end developer e ancora oggi studio per
