          ...
          <div className="size-large">
            ...
            <div className="article-base flex-left-column">
              ...
              <p>
                ...
                quas itaque ad exercitationem repellat iste Lorem ipsum dolor
                sit amet consectetur adipisicing elit. Pariatur, eius qui dicta
                itaque minus odit maiores aut dolore similique a? Eligendi eum
                laudantium iusto voluptates maxime quas itaque ad exercitationem
                repellat iste
              </p>
            </div>
            ...
            <div className="article-links">
              ...
              <ul>
                <li>
                  <a href="">Link alla pagina esterna</a>
                </li>
                <li>
                  <a href="">Link alla pagina esterna</a>
                </li>
